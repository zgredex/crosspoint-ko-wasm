...
struct ReaderRenderSpec {
  ...
  // Korean: first-line indent, independent of extraParagraphSpacing.
  bool paragraphIndent = false;
  // Korean: break lines at any character rather than only at spaces. When set,
  // hyphenation is inert (there are no word boundaries to hyphenate at) — the
  // reader gates hyphenationEnabled on this being clear.
